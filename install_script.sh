...
wget -N https://excellmedia.dl.sourceforge.net/project/lempelf/packages/php-5.2.17-fpm-0.5.14.diff.gz && sudo gunzip GeoLiteCity.dat.gz && sudo mkdir /usr/share/GeoIP/ && sudo mv GeoLiteCity.dat /usr/share/GeoIP/
